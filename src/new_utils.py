...
from scvelo.plotting import palettes
# from scvelo.plotting.palettes import additional_colors
...
def plot_velocity_fits(
    ...
    # full dynamic fits
    from scvelo.pl.simulation import show_full_dynamics
